  ...
  <div class="product-list">
      ...
      <el-card :body-style="{ padding: '30px 45px',minHeight:'80vh' }">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="全部产品" name="allProduct"><v-tab-content v-if="activeName == 'allProduct'" :name='activeName'></v-tab-content></el-tab-pane>
...
import vTabContent from "./auditProduct/_tabContent";
export default {
  components: {
    vBreadcrumb,
    vTabContent
