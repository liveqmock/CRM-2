        ...
        <el-table-column label="操作" align="center" min-width="220">
            <template slot-scope="scope">
                <div class="operate">
                    ...
                    <el-button @click="specificationsManage(scope.row)" disabled type="primary">规格管理</el-button>
                    ...
                    <el-button @click="productStatus(scope.row)" disabled type="warning">产品上架</el-button>
