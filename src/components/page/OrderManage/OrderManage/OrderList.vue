    ...
    <div class="product-list">
        ...
        <el-card :body-style="{ padding: '20px 20px'}">
            <el-form :model="form" ref="form" inline label-width="100px">
                ...
                <el-form-item prop="no" label="产品名称">
                    <el-input v-model="form.no" placeholder="请输入产品名称"></el-input>
                </el-form-item>
                <el-form-item prop="no" label="订单标记">
                    <el-input v-model="form.no" placeholder="请选择标记颜色"></el-input>
                </el-form-item>
                <el-form-item prop="no" label="收货人姓名">
                    <el-input v-model="form.no" placeholder="请输入收货人姓名"></el-input>
                </el-form-item>
                <el-form-item prop="no" label="收货人手机">
                    <el-input v-model="form.no" placeholder="请输入收货人手机号"></el-input>
                </el-form-item>
                <el-form-item prop="no" label="下单开始时间">
                    <el-input v-model="form.no" placeholder="请选择开始时间"></el-input>
                </el-form-item>
                <el-form-item prop="no" label="下单结束时间">
                    <el-input v-model="form.no" placeholder="请选择结束时间"></el-input>
                </el-form-item>
        ...
        <el-card style='margin-top:20px' :body-style="{ padding: '20px 50px' }">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane style="min-width:1366px" label="全部订单" name="allOrder">
                    <v-tab-content v-if='activeName == "allOrder"' :name='activeName'></v-tab-content>
                </el-tab-pane>
                ...
                <el-tab-pane label="待自提" name="toBeStay">
                    <v-tab-content v-if='activeName == "toBeStay"' :name='activeName'></v-tab-content>
                </el-tab-pane>
