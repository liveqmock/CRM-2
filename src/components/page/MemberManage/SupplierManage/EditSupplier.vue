            ...
            <div class="supplier-box">
                <el-form :model="form" ref="form">
                    ...
                    <el-form-item class="classify-area" prop="productcIds" label="供应产品品类品牌">
                        ...
                        <div class="intent">
                            <v-choosebrand @brandids="brandids" v-model="form.brandids" :detailBrand="detailBrand"
...
<script>
    ...
    import vChoosebrand from '../../../common/chooseBrand.vue';
    ...
    export default {
        ...
        methods: {
            ...
            submitForm(form) {
                ...
                if(!that.form.bankName||!that.form.bankOpening){
